    ...
    public abstract class TargetController : MonoBehaviour
    {
        ...
        private class InMotion : StateBase
        {
            ...
            public override void Exit(TargetController controller)
            {
                ...
                controller.OperationLock.Locked = false;
                controller.SkillLock.Locked = false;
                var v = controller.rb.velocity.y;
                controller.rb.velocity = new Vector2(0, v);
            }
        }
        ...
        public virtual void Init(Target t, Dictionary<TargetParams, string> param)
        {
            target = t;
            ...
            if (param.ContainsKey(TargetParams.CanFly)) canFly = param[TargetParams.CanFly] == "1";
