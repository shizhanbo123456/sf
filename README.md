...
EnsNetcode 是专为 Unity 打造的轻量级游戏网络框架，核心实现**游戏逻辑与网络字节流的双向转换**，无需依赖其它网络库，支持**局域网联机**与**远程分房间联机**便捷切换，两套模式核心逻辑完全复用。因**本质为游戏逻辑和字节流的封装**，因此支持适配到任何能够传输字节的平台，允许协议拓展。
