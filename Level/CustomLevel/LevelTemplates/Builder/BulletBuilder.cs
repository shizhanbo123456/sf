...
namespace LevelCreator
{
    ...
    public struct BulletInfo : Info
    {
        ...
        public BulletInfo(short id, int graphicType, float radius, float lifeTime, float rate, int liftstoiclevel, float hitbackForce,short effect)
        {
            this.id = id;
    ...
    public struct BulletInfoSerializer
    {
        public static bool Serialize(BulletInfo value, byte[] result, ref int indexStart)
        {
            ...
            if (!ShortSerializer.Serialize(value.effect, result, ref indexStart)) return false;
            return true;
        }
        ...
        public static BulletInfo Deserialize(byte[] data, ref int indexStart, int invalidIndex)
        {
            ...
            info.effect = ShortSerializer.Deserialize(data, ref indexStart, invalidIndex);
            return info;
        }
    }
}